...
// Enqueue logic
void Enqueue(readyQ *q, Process *p)
{
...
void Printing(Process processes[], int num_processes, int current_time, Process *running_process, readyQ rq, int completed)
{
